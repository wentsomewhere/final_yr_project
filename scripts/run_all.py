...
def setup_logging(log_dir: str):
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(os.path.join(log_dir, 'run_all.log')),
...
def main():
    parser = argparse.ArgumentParser(description='Run all SRR-GAN components')
    ...
    logging.info("Starting all SRR-GAN components...")
